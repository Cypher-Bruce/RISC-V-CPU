...
/// Input: clock, reset, TubeCtrl, in_num
/// Output: oDigitalTubeNotEnable, oDigitalTubeShape
/// Usage:
///     1. See the comments below
///     2. TubeCtrl sets to 1 if we want to display a new number, otherwise keep the same
///     3. Refer to TEST_TubeDriver_tb.v test details
module TubeDriver(
